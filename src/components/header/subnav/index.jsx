...
const Subnav = () =>{
    ...
    return(
        <div className="Subnav flex justify-between items-center px-10 md:px-16 py-6 w-full truncate mb-0">
            ...
            <ul className="flex gap-5 font-bold w-full overflow-scroll scrollbar-hidden items-center xl:justify-center">
                {
                    navs.map(elem=>
                        <li key={elem} className="px-3 hover:opacity-60 cursor-pointer py-1 text-sm rounded-full">{elem}</li>
                    )
                }
            </ul>
